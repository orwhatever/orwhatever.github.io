...
function loadFloor(projectionMatrix, viewMatrix) {
    ...
    var AB = subtract(floorVertexB, floorVertexA);
    var AD = subtract(floorVertexD, floorVertexA);

    floorObject.A = floorVertexA;
    floorObject.B = floorVertexB;
    floorObject.C = floorVertexC;
    floorObject.D = floorVertexD;

    floorObject.N = normalize(cross(AB, AD));
