...
const eye = vec3(0, 0, viewDistance);
...
window.onload = function init() {
    ...
    backgroundObject = loadBackgroundQuad(projectionMatrix);
...
function drawBackground() {
    ...
    gl.uniformMatrix4fv(program.MtexLoc, false, flatten(backgroundObject.Mtex));
    gl.uniform1i(program.isMirrorLoc, 0);
    gl.uniform4fv(program.eyeLoc,vec4(eye));

    gl.activeTexture(gl.TEXTURE0);
    gl.bindTexture(gl.TEXTURE_CUBE_MAP, backgroundObject.cubeMap);
    gl.uniform1i(program.cubeSampler, 0);
