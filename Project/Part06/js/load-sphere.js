...
function loadSphere(projectionMatrix, viewMatrix) {
    ...
    sphereObject.viewMatrix = viewMatrix;
    sphereObject.modelMatrix = mult(translate(-0.5, 0, -0.5), scalem(0.35, 0.35, 0.35));
