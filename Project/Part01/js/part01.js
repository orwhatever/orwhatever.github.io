...
const eye = vec3(viewDistance, 0, viewDistance);
...
function drawSphere() {
    ...
    gl.bindBuffer(gl.ARRAY_BUFFER, sphereObject.colorBuffer);
    gl.vertexAttribPointer(program.vColorLoc, 4, gl.FLOAT, false, 0, 0);
    gl.enableVertexAttribArray(program.vColorLoc);
...
function drawBackground() {
    ...
    gl.bindBuffer(gl.ARRAY_BUFFER, backgroundObject.colorBuffer);
    gl.vertexAttribPointer(program.vColorLoc, 4, gl.FLOAT, false, 0, 0);
    gl.enableVertexAttribArray(program.vColorLoc);

    gl.uniformMatrix4fv(program.modelViewMatrixLoc, false, flatten(backgroundObject.modelViewMatrix));
